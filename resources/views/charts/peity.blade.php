<!-- resources/views/charts/peity.blade.php -->
@extends('layouts.app')
@section('title', 'Icons Peity Charts')
...
@section('bc-title', 'Peity Charts')
@section('bc-first', 'Icons')
@section('bc-mid', 'Charts')
@section('bc-last', 'Peity Charts')
...
<!-- scripit init-->
<script src="{{asset('js/init/peitychart-init.js')}}"></script>
<!-- scripit init-->
@endpush
